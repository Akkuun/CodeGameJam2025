...
//        Debug.Log(" Hello " + secondJumpForce);
    ...
    void Jump(float force)
    {
        if (isGrounded)
        {
            ...
            jumpSFX.pitch = UnityEngine.Random.Range(0.9f, 1.1f);
            jumpSFX.Play();
        }
        else
        {
    ...
    void DoubleJump(float force)
    {
        if (canDoubleJump)
        {
            ...
            animator.SetTrigger("DoubleJump");
            canDoubleJump = false;
            doubleJumpSFX.pitch = UnityEngine.Random.Range(0.9f, 1.1f);
            doubleJumpSFX.Play();
        }
    ...
    public void ActivateJumpPad(float jumpPadForce)
    {
        ...
        Debug.Log("heh");
        jumpPadSFX.pitch = UnityEngine.Random.Range(0.9f, 1.1f);
        jumpPadSFX.Play();
    }
    ...
    public void triggerDeath() {
        ...
        deathSFX.pitch = UnityEngine.Random.Range(0.9f, 1.1f);
        deathSFX.Play();
        deathEffect.Play();
